...
## Arquitectura de capturas (TUI → repo iCloud)

**Repo canónico:** iCloud `GitHub/antropologia-corrupcion` (org `vientonorte`).  
**Capturas ≠ editorial.** Foto → Estado del Arte; cita → `data/*-citas.json`.

| Clave | Destino foto |
|---|---|
| B (libro) | `src/docs/Estado del Arte/Citas <Libro>/` |
| A (Bullet Ro) | `src/docs/Estado del Arte/ciper-mvp/assets/inbox-clave-a/` |
...
Una cita editorial por fragmento. Leyenda / duplicado de ángulo / pestaña vacía ≠ fila JSON.
