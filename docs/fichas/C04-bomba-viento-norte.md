# Ficha C.04 — Bomba (Colectivo Viento Norte)
...
**Primarias:**
- Poema performático "Bomba", leído en la Reunión del Comité Social por los DDHH, Valparaíso, 18 noviembre 2026. Texto completo en `Estado del Arte/Poemarios/2026-11-18-bomba-viento-norte.md`.

**Secundarias:**
- [PENDIENTE: verificar existencia de cobertura de prensa de la reunión del 18/11/2026 en Valparaíso]
- [PENDIENTE: identificar publicaciones del Comité Social por los DDHH Valparaíso]

**Bibliografía teórica vinculada:**
- Das, Veena & Poole, Deborah (eds.) (2004). *Anthropology in the Margins of the State*. School of American Research Press.
- Dussel, Enrique (2011). *Philosophy of Liberation*. Wipf and Stock. [Referencia directa en el texto fuente]
- Mbembe, Achille (2003). "Necropolitics". *Public Culture*, 15(1), 11–40.
- Taussig, Michael (1992). *The Nervous System*. Routledge.
- Zuboff, Shoshana (2019). *The Age of Surveillance Capitalism*. PublicAffairs. [Anclaje complementario: "capitalismo de vigilancia" aparece literal en el texto]

---

## Open coding

Códigos emergentes del material (sin imponer categorías previas):

- `dualidad_laboral`: dos empleos que se tensionan estructuralmente — el trabajo formal remunerado (AFP Capital) y el trabajo político no remunerado (activismo en DDHH). *Hecho documentado en el texto.*
- `vigilancia_corporativa`: AFP Capital despliega 5 agentes de ciberseguridad ante la tesis del narrador-poeta. *Hecho documentado en el texto; magnitud y carácter no verificados externamente → hipótesis investigativa.*
- `cuerpo_lesionado`: 2 esguines en manos, 1 en los pies. El cuerpo como soporte que sigue moviéndose pese al daño. *Hecho documentado en el texto.*
- `resistencia_como_ontología`: "Todo lo que hago es una protesta / Desde que me levanto en la mañana." La resistencia no es evento sino modo de existencia.
- `contravigilancia_visual`: "Los pacos me dispararon, les saqué fotos." La cámara del subalterno como dispositivo de registro inverso.
...
- `activismo_colectivo_presencial`: Comité Social por los DDHH en Valparaíso. El espacio físico de reunión como nodo de contrapoder.
- `memoria_territorial`: Valparaíso, el cerro, BAJ. La ciudad como archivo corporal y espacial de la resistencia.
- `tejido_como_protesta`: "Hasta que me acuesto en la noche después de tejer / Enhebro día a día en búsqueda de tu mirar." El tejido como práctica política feminizada — tradición de las arpilleras.
- `episteme_poetica`: la poesía captura lo que el documento institucional borra. Metaepistemología inscrita en el propio texto.
...
- `dualidad_laboral` ↔ `vigilancia_corporativa` · relación: **causalidad**: el trabajo político activa el aparato de vigilancia del trabajo formal
- `dualidad_laboral` ↔ `protesta_encubierta` · relación: **táctica de sobrevivencia**: el sujeto gestiona la coexistencia de los dos regímenes
- `cuerpo_lesionado` ↔ `resistencia_como_ontología` · relación: **paradoja productiva**: el cuerpo dañado sigue siendo el sitio de la acción
- `cifra_de_desaparecidos` ↔ `borramiento_institucional` · relación: **contradicción**: la cifra activa (1313) niega el borramiento ("preguntas mal hechas")
- `contravigilancia_visual` ↔ `vigilancia_corporativa` · relación: **inversión del dispositivo**: la cámara del vigilado regresa la mirada
- `interpelacion_directa` ↔ `episteme_poetica` · relación: **ruptura del eufemismo**: la poesía nombra donde el informe tergiversa
- `filosofia_liberacion_como_etica_minima` ↔ `precariedad_comparativa` · relación: **anclaje ético ante la desproporción**: Dussel como respuesta filosófica a la asimetría de poder
- `tejido_como_protesta` ↔ `resistencia_como_ontología` · relación: **continuidad práctica**: el tejido nocturno extiende la protesta al espacio doméstico
- `cifra_como_absurdo` ↔ `borramiento_institucional` · relación: **denuncia por reenvío**: el lenguaje técnico corporativo es exactamente el instrumento del borramiento

**Categorías agrupadoras:**

- **Vigilancia diferencial**: agrupa [`vigilancia_corporativa`, `contravigilancia_visual`, `protesta_encubierta`, `cifra_como_absurdo`] — el sistema de AFP produce un aparato de vigilancia sobre el trabajador-activista; el trabajador lo devuelve.
- **Cuerpo-territorio como archivo vivo**: agrupa [`cuerpo_lesionado`, `resistencia_como_ontología`, `memoria_territorial`, `tejido_como_protesta`] — el cuerpo que habita el cerro, que teje, que marcha con esguines, es el soporte material de la memoria que la institución no puede archivar.
- **Cifra y borramiento**: agrupa [`cifra_de_desaparecidos`, `borramiento_institucional`, `precariedad_comparativa`, `interpelacion_directa`] — los números operan en dos sentidos: como instrumento de conteo corporativo (vigilancia, estadística) y como arma de memoria activista (1313).
- **Contrapoética como epistemología**: agrupa [`episteme_poetica`, `filosofia_liberacion_como_etica_minima`, `dualidad_laboral`] — la elección de la poesía como forma no es estética sino epistémica: captura lo que el contrato laboral y el informe de ciberseguridad eliden.

---

## Selective coding

**Categoría central:** Mistranslación del cuerpo-archivo

**Hipótesis teórica:**  
El poema evidencia que AFP Capital —como sistema de vigilancia corporativa— opera una *mistranslación* sobre el sujeto-trabajador: traduce su activismo político en riesgo laboral cuantificable (5 agentes de ciberseguridad, distribución estadística), borrando la dimensión política de ese cuerpo y reduciéndolo a variable de control. El sujeto responde con una episteme inversa: la poesía hace lo que el informe corporativo no puede —nombra actores, territorializa la memoria, inscribe el daño corporal como dato de archivo. El cuerpo lesionado que marcha, teje y fotodocumenta a los pacos es el archivo vivo que la institución no logra clausurar. *Inferencia teórica*: la dualidad laboral no es anomalía biográfica sino expresión de la contradicción estructural entre regímenes de verdad —el jurídico-laboral y el testimonial-activista— que es, en el marco de esta investigación, el sitio de fricción primario.
...
- **Información**: capturas de pantalla y fotos como evidencia; la tesis como objeto de vigilancia.
- **Cuerpo**: soporte físico dañado (esguines) que sigue siendo instrumento de acción.
- **Afecto y práctica**: amor, tejido, búsqueda — recursos no mercantilizados que sostienen la resistencia.
...
### D4 · Espacialidad
- **Valparaíso / BAJ / el cerro**: territorio de activismo, memoria y resistencia. Espacio urbano popular con historia de organización social.
- **Sala de reunión del Comité**: espacio de deliberación colectiva, contrapúblico.
- **Lugar de trabajo (AFP Capital)**: espacio del contrato, la vigilancia y la extracción.
- **Espacio doméstico**: levantarse, acostarse, tejer — la resistencia no se detiene en el umbral del hogar.

### D5 · Temporalidad
- **Tiempo puntual**: 18 noviembre 2026 — la reunión como evento performático y político.
- **Tiempo largo**: 1313 desaparecidos — memoria que excede el presente y arrastra el pasado reciente chileno.
- **Tiempo del cuerpo cotidiano**: desde que me levanto / hasta que me acuesto — la resistencia como duración, no como episodio.
- **Tiempo biográfico**: "12 mil kilómetros", "años de experiencia", primer poema escolar — la trayectoria como evidencia acumulada.

### D6 · Discursividad
- **Registro técnico-corporativo invadiendo el poema**: "distribución estadística", "capitalismo de vigilancia", "agentes de ciberseguridad" — el léxico de la empresa aparece en el poema como cuerpo extraño, paródico.
- **Interpelación directa como ruptura del eufemismo**: nombrar a Raúl Astudillo y a AFP Capital rompe la lógica del informe que generaliza, anonimiza, abstrae.
- **Silencio estratégico**: "Me di color, no contesté" — el no-decir como táctica de resistencia.
- **Cifra como discurso**: "1313 cuerpos" vs. "distribución estadística" — dos usos del número, dos regímenes de verdad.

### D7 · Materialidad
- **Capturas de pantalla**: evidencia digital producida por el trabajador-activista; contraarchivo de la vigilancia.
- **Fotografías de la acción policial**: "les saqué fotos" — tecnología de contravigilancia.
- **El teléfono**: "chat chat / chat chat" — dispositivo de vigilancia corporativa y de comunicación política, simultáneamente.
- **El tejido / la lana**: práctica material que extiende la resistencia al tiempo doméstico.
- **La tesis**: objeto de vigilancia corporativa — el texto académico como amenaza percibida.
- **El cuerpo con esguines**: materialidad dañada que continúa.

**Dimensiones ausentes / saturadas / contradictorias:**
- **D3 (Normatividad)** está *parcialmente saturada*: el poema nombra la vigilancia pero no cita instrumentos normativos específicos. Es *hallazgo*: la experiencia del sujeto no requiere el nombre de la ley para ser real — la ley se experimenta sin ser nombrada.
- **D2 (Recursos)** evidencia una ausencia notable: el dinero como recurso aparece solo para subrayar su insuficiencia ("ni el treceavo amazano"). Lo que sostiene la acción no es capital económico sino afectivo y político.

---

## Sitio de fricción / mistraducción

**Identificación:** La empresa AFP Capital traduce la actividad política e investigativa del trabajador (tesis doctoral, asistencia a reunión de DDHH) en *riesgo de seguridad corporativa*, activando 5 agentes de ciberseguridad. La mistranslación opera entre el régimen testimonial-activista (el sujeto como investigador, activista, poeta) y el régimen jurídico-laboral (el sujeto como empleado, variable de riesgo). El "trabajo número 2" —la investigación, el activismo— no existe en el contrato laboral; su existencia es, desde el régimen de la empresa, una anomalía que hay que contener.

**Anchor teórico:**
> "The margins of the state are not simply places where the law is weak or absent... Rather they are places where the state... appears as something both powerful and unstable, distant and near." (Das & Poole, 2004: 19)

**Análisis:**  
Das y Poole proponen los márgenes del Estado como sitio donde el poder se hace visible precisamente en su inestabilidad. La reunión del Comité Social por los DDHH en Valparaíso opera exactamente en ese margen: es el espacio donde el Estado aparece en su forma policial (los pacos que disparan) y en su forma archivística defectuosa (los 1313 "borrados a preguntas mal hechas"). La corporation AFP Capital no es el Estado pero opera su lógica de margen desde dentro de la relación laboral: produce el sujeto-activista como anomalía que hay que archivar, vigilar, contener. El poema se escribe desde ese margen y lo nombra sin eufemismo. *Inferencia teórica*: en el Chile neoliberal, la empresa financiera privatiza no solo la pensión sino la gestión del margen — desplaza hacia el contrato laboral la función de control que el Estado ejerce en el territorio.

---

## Visualización (d3-force)

**Nodos:**
- `VientoNorte` · tipo: sujeto-activista · atributos: {rol: "trabajador/poeta/investigador", ubicacion: "Valparaíso"}
...
**Edges:**
- `VientoNorte` → `AFP_Capital` · tipo: relación laboral · peso: 3
- `AFP_Capital` → `VientoNorte` · tipo: vigilancia corporativa · peso: 4
- `VientoNorte` → `Comite_DDHH_Valpo` · tipo: activismo · peso: 4
- `Comite_DDHH_Valpo` → `1313_desaparecidos` · tipo: memoria-cifra · peso: 3
- `VientoNorte` → `Tesis` · tipo: producción investigativa · peso: 3
- `AFP_Capital` → `Tesis` · tipo: vigilancia-amenaza · peso: 4
- `VientoNorte` → `Dussel` · tipo: anclaje ético · peso: 2
- `VientoNorte` → `Raul_Astudillo` · tipo: interpelación directa · peso: 2
- `Cuerpo` → `AFP_Capital` · tipo: trabajo-1 · peso: 2
- `Cuerpo` → `Comite_DDHH_Valpo` · tipo: trabajo-2/resistencia · peso: 4

**Propuesta de layout:** force-directed con `AFP_Capital` y `Comite_DDHH_Valpo` como polos de atracción opuestos sobre `VientoNorte`/`Cuerpo`. La tensión entre los dos trabajos debe ser visible como tirón espacial.
...
- **C02** — Sistema de pensiones chileno como archivo previsional privatizado. AFP Capital como actor-empresa que en C04 cobra dimensión concreta: de sistema a relación laboral de vigilancia.
- **C03** — Protocolo de documentación. La discusión sobre episteme de archivo tiene correlato directo: el poema es un documento que captura lo que el protocolo institucional no puede.
